...
#SBATCH -o ../../out/window_%a.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e ../../err/window_%a.err  # File to which STDERR will be written, %j inserts jobid
