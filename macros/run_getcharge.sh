...
TRIGGER=trigger1
TAG=w15_20032023
THISDIR=/n/holystore01/LABS/guenette_lab/Users/tcontreras/nz_studies/data/
...
python  /n/holystore01/LABS/guenette_lab/Users/tcontreras/nz_studies/nz_analysis/macros/GetCharge.py ${RUNNUM} ${FILESTART} ${OUTFILESTART} ${SLURM_ARRAY_TASK_ID} ${DCUTS} ${STHRESH} ${TAG} ${TRIGGER}
