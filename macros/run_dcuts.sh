#!/bin/bash
#SBATCH -J nz_dcuts    # A single job name for the array
...
#SBATCH -o ../../out/dcuts.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e ../../err/dcuts.err  # File to which STDERR will be written, %j inserts jobid
...
python  /n/holystore01/LABS/guenette_lab/Users/tcontreras/nz_studies/nz_analysis/macros/raw_window.py 
