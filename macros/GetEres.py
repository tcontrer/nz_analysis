...
print('e0, lt', lower_e0, upper_e0, lt_seed)
...
#plt.hist(dst.Z, range=(0,600), bins=50)
#plt.savefig(outputdir+'test_z.png')
#plt.hist(dst.S2q, range=(0,5000))
#plt.savefig(outputdir+'test_s2q.png', bins=50)
